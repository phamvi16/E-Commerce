...
@section('content')
    <div id="breadcrumb">
        ...
        <a href="{{route('slider.index')}}" class="current">Sliders</a>
    </div>
            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                    ...
                    @foreach($sliders as $sli)
                        ...
                        <tr class="gradeC">
                            <td><i>{{$i}}</i></td>
                            <td style="vertical-align: middle;">{{$sli->slider_name}}</td>
                            <td style="text-align: center;"><img src="{{url('sliders/imgs',$sli->slider_image)}}" alt="" width="50"></td>
                            <td style="vertical-align: middle;">{{$sli->slider_desc}}</td>
